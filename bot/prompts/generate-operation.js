  ...
  return [
    {
      ...
      content: [
        ...
        "If entitySchema allows detailsHtml and the user message contains formatting, paragraphs, inline links, or structured source text that should survive rendering, populate detailsHtml instead of flattening it.",
        "When you set detailsHtml for participant or project, also keep the companion plain-text field coherent: bio for participant, summary for project.",
        "When you set detailsHtml for meeting or announcement, also return paragraphs when they can be cleanly preserved.",
        "If the turn includes photo attachments and the user is creating or updating the entity, do not drop the photos.",
        "Use assetActions or explicit photo fields so attached photos become part of the saved entity.",
        "For projects, attached photos should become gallery items; when there is no contrary instruction, a new project photo can become the initial main photo, and additional photos for an existing project can be appended.",
        "For announcements, meetings, and participants, an attached photo can become the main photo when the user is creating or updating that entity and does not ask to remove media.",
        "Do not restate unchanged fields unless required for correctness.",
        "For participant handles and Telegram links, never derive a Telegram URL or @handle from a slug, name, or inferred identifier.",
        "Only set participant.handle when the user directly provides a Telegram-style @handle.",
        "Only add a Telegram entry to links when the user directly provides an explicit Telegram URL such as https://t.me/name, t.me/name, or a Telegram handle intended as contact information.",
        "If the user provides both an explicit Telegram URL and a different slug or display handle, preserve only the explicit Telegram URL in links and do not synthesize another Telegram link.",
        "Return JSON only.",
