...
function buildSystemPrompt() {
  return [
    ...
    "Project news or project updates should usually use entity = announcement, not meeting.",
    "When a project-linked post should appear as project news, keep entity = announcement, set fields.format = 'news', and include fields.projectSlugs with the related project slugs when known.",
    "If the user asks to transfer an existing announcement into a meeting article, keep action = update and set fields.type = 'meeting'.",
    "If the user asks to move an existing meeting article back into announcements/news, keep action = update and set fields.type = 'announce'.",
